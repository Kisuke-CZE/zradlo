...
modules = ["kozlovna", "kolkovna", "avion58", "vrtule", "pinta", "petpenez", "motoburger", "hamburg", "hurrycurry" , "baterka", "uholise", "port_stanley", "jatka78", "extolinn" , "port58", "phillscorner", "lacasa", "kantyna"]
imported = []
for i in modules:
